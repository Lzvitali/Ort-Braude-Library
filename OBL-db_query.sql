...
INSERT INTO `ReaderAccount` (`ID`,`firstName`,`lastName`,`phone`,`email`,`address`) VALUES 
 ...
 ('205727995','Inbar','Moshe','0547898892','inbarmoshe4@gmail.com‬',"Haifa",3),
...
CREATE TABLE `History` (
 ...
 ('354126424','2018-11-30','Registration to OBL'),
 ('241848926','2018-11-30','Registration to OBL'),
  ('336489242','2018-11-30','Registration to OBL'),
 ('223646897','2018-11-30','Registration to OBL'),
  ('203332228','2018-11-30','Registration to OBL'),
  ('216897163','2018-11-30','Registration to OBL'),
 ('302134873','2018-11-30','Registration to OBL'),
 ('308328758','2018-11-30','Registration to OBL'),
 ('205727995','2018-11-30','Registration to OBL'),
 ('319611606','2018-11-30','Registration to OBL'),
  ('354946422','2018-11-30','Registration to OBL'),
  ('247891429','2018-11-30','Registration to OBL');
  
  INSERT INTO `History` (`Date`,`action`,`note`) VALUES 
   ('2018-12-01','Active readerAccounts','9'),
 ('2018-12-01','Freezed readerAccounts','2'),
 ('2018-12-01','Locked readerAccounts','1'),
 ('2018-12-01','quantity of copies','42');
 
   INSERT INTO `History` (`Date`,`action`,`note`) VALUES 
   ('2019-01-01','Active readerAccounts','12'),
 ('2019-01-01','Freezed readerAccounts','0'),
 ('2019-01-01','Locked readerAccounts','0'),
 ('2019-01-01','quantity of copies','38'),
 ...
 (7,35,'247891429','2019-02-05','Borrow book');
    ...
    INSERT INTO `History` (`bookId`,`copyId`,`readerAccountID`,`Date`,`action`) VALUES 
   (11,8,'354126424','2019-01-02','Borrow book'),
 (13,7,'308328758','2019-01-05','Borrow book');
 
     INSERT INTO `History` (`bookId`,`copyId`,`readerAccountID`,`Date`,`action`,`Note`) VALUES 
 (11,8,'354126424','2019-01-05','Return book','3'),
 (13,7,'308328758','2019-01-08','Return book','3');
...
UPDATE `obl`.`readeraccount` SET `numOfDelays` = '1' WHERE (`ID` = '354126424');
UPDATE `obl`.`readeraccount` SET `numOfDelays` = '1' WHERE (`ID` = '308328758');

INSERT INTO `obl`.`history` (`readerAccountID`, `bookId`, `copyId`, `action`, `date`) VALUES ('319611606', '21', '1', 'Borrow book', '2019-01-02');
INSERT INTO `obl`.`history` (`readerAccountID`, `bookId`, `copyId`, `action`, `date`, `Note`) VALUES ('319611606', '21', '1', 'Return book', '2019-01-07', '5');
INSERT INTO `obl`.`history` (`readerAccountID`, `bookId`, `copyId`, `action`, `date`) VALUES ('354126424', '22', '2', 'Late in return', '2019-01-18');
INSERT INTO `obl`.`history` (`readerAccountID`, `bookId`, `copyId`, `action`, `date`, `Note`) VALUES ('354126424', '22', '2', 'Return book', '2019-01-22', '19');
INSERT INTO `obl`.`history` (`readerAccountID`, `bookId`, `copyId`, `action`, `date`, `Note`) VALUES ('308328758', '23', '3', 'Late in return', '2019-01-18', '');
INSERT INTO `obl`.`history` (`readerAccountID`, `bookId`, `copyId`, `action`, `date`, `Note`) VALUES ('308328758', '23', '3', 'Return book', '2019-01-25', '22');

UPDATE `obl`.`book` SET `isDesired` = '1' WHERE (`bookId` = '11');
UPDATE `obl`.`book` SET `isDesired` = '1' WHERE (`bookId` = '13');
